...
void _main(void)
{
	...
	{
		if( (sys_pf_calculate_allocated_pages() - usedDiskPages) !=  0) panic("Unexpected extra/less pages have been added to page file.. NOT Expected to add new pages to the page file ac%d, ex%d",sys_pf_calculate_allocated_pages(), usedDiskPages);
